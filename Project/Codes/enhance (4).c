...
float *m1,*m2,*m3,*m4,*mag,*noisemag,*temp,*g,*p,*p_prev;
float ALPHA=20;
float LAMBDA=0.1;
float TAU = 0.02;
 /******************************* Function prototypes *******************************/
...
//		switch(enhance)
//		{
//			case 1: p[i] = (1-k)*mag[i] + k*p_prev[i];
//					mag[i] = p[i];
//					break;
//			case 2:
//			case 3: 
//			case 4:	p[i] = (1-k)*mag[i]*mag[i] + k*p_prev[i];
//					mag[i] = sqrt(p[i]);
//					break;
//			default:mag[i] = mag[i];		
//		}
...
//		{
//			case 3: 
//			case 4:	noisemag[i] = (1-k)*noisemag[i] + k*noisemag[i-1];
//					break;
//			default:noisemag[i] = noisemag[i];
//		}
...
//						break;
//				case 5: g[i] = max(LAMBDA,1-noisemag[i]/p[i]);
//						break;
//				case 6: g[i] = max(LAMBDA,sqrt(1-pow(noiseratio,2)));
//						break;
